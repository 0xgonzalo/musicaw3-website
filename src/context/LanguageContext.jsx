  ...
  en: {
    ...
    wow: {
      ...
      features: [
        ...
        'Extensive network of artists, curators and supporters around LATAM',
      ],
      collectors: {
        badge: 'For Collectors',
        title: 'Rewards for Artifact Collectors',
        description: 'Voters and artifact collectors gain access to an exclusive rewards drop. Collecting artifacts is not only a way to support the festival, but also a way to become an active participant in its cultural and creative growth.',
        rewards: [
          'AI-generated Artifacts (Bronze / Silver / Gold / Diamond)',
          'Commemorative festival POAP',
          'Access to digital rewards and future ecosystem benefits',
          'Exclusive drop of original MusicaW3 songs',
          'Priority access to future music releases',
          'Public recognition within the MusicaW3 ecosystem',
        ],
      },
      tiers: {
        badge: 'Collector Tiers',
        title: 'Artifact Collector Tiers',
        description: 'The more you collect, the more you unlock. Each tier brings increasing value, exclusivity, and deeper participation in the MusicaW3 ecosystem.',
        bronze: {
          name: 'Bronze',
      ...
      firstWeek: {
        ...
        bonuses: [
          ...
          'Commemorative POAP via Spaces and redeemable codes',
        ],
  ...
  es: {
    ...
    wow: {
      ...
      features: [
        ...
        'Amplia red de artistas, curadores y colaboradores en toda LATAM',
      ],
      collectors: {
        badge: 'Para Coleccionistas',
        title: 'Recompensas para Collectors de Artifacts',
        description: 'Los votantes y coleccionistas de Artifacts obtienen acceso a un drop exclusivo de recompensas. Coleccionar Artifacts no solo es una forma de apoyar el festival, sino también una forma de convertirse en un participante activo en su crecimiento cultural y creativo.',
        rewards: [
          'Artifacts (Bronce / Plata / Oro / Diamante)',
          'POAP conmemorativo del festival',
          'Acceso a recompensas digitales y beneficios futuros del ecosistema',
          'Drop exclusivo de canciones originales de MusicaW3',
          'Acceso prioritario a futuros lanzamientos musicales',
          'Reconocimiento público dentro del ecosistema MusicaW3',
        ],
      },
      tiers: {
        badge: 'Niveles de Collectors',
        title: 'Niveles de Collectors',
        description: 'Cuanto más coleccionas, más desbloqueas. Cada nivel trae mayor valor, exclusividad y participación más profunda en el ecosistema MusicaW3.',
        bronze: {
          name: 'Bronce',
          artifacts: '1 Artifact',
          benefits: [
      ...
      firstWeek: {
        ...
        bonuses: [
          ...
          'POAP conmemorativo vía Spaces y códigos canjeables',
        ],
